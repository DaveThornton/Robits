...
onready var joint1 = $Joint_1
onready var joint2 = $Joint_1/Joint_2
onready var hand = $Joint_1/Joint_2/Hand
...
#onready var joint_2 = $Joint_1/Joint_2
#onready var hand = $Joint_1/Joint_2/Hand
#
#onready var leg_s = $Sprite_Leg_01
#onready var joint_1_s = $Joint_1/Sprite_Joint_1
#onready var joint_2_s = $Joint_1/Joint_2/Sprite_Joint_2
#var len_up = 0
#var len_mid = 0
#var len_low= 0
#
#func _ready():
#	len_up = joint_1.position.x
#	len_mid = joint_2.position.x
#	len_low= hand.position.x
#	if flipped:
#		leg_s.flip_h = true
#		joint_1_s.flip_h = true
#		joint_2_s.flip_h = true
#
#func _process(delta):
#	update_ik(get_global_mouse_position())
#
...
#		dis_to_tar = MIN_DIST
#	var base_r = offset.angle()
#	var len_total = len_up + len_mid + len_low
#	var len_dummy_side = (len_up + len_mid) * clamp( dis_to_tar / len_total, 0.0, 1.0 )
#
