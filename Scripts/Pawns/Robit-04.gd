...
func init(_player_num, _pos, _start_equiped, _play_type):
	...
	if player == 1:
		sprite.texture = load("res://Sprites/Pawns/Robit_Pawn-04-01.png")
	elif player == 2:
		sprite.texture = load("res://Sprites/Pawns/Robit_Pawn-04-02.png")
	elif player == 3:
		sprite.texture = load("res://Sprites/Pawns/Robit_Pawn-04-03.png")
	elif player == 4:
		sprite.texture = load("res://Sprites/Pawns/Robit_Pawn-04-04.png")
	elif player == 5:
		sprite.texture = load("res://Sprites/Pawns/Robit_Pawn-04-05.png")
	elif player == 6:
		sprite.texture = load("res://Sprites/Pawns/Robit_Pawn-04-06.png")
	elif player == 7:
		sprite.texture = load("res://Sprites/Pawns/Robit_Pawn-04-07.png")
	elif player == 8:
		sprite.texture = load("res://Sprites/Pawns/Robit_Pawn-04-08.png")
	else:
