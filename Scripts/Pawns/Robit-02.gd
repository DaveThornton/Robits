...
func _old_set_color():
	if player == 1:#Grey
		...
		sprite_loco.self_modulate = Player_Stats.p1.color_2
		...
		sprite_loco.self_modulate = Player_Stats.p2.color_2
		...
		sprite_loco.self_modulate = Player_Stats.p3.color_2
		...
		sprite_loco.self_modulate = Player_Stats.p4.color_2
		...
		sprite_loco.self_modulate = Player_Stats.p5.color_2
		...
		sprite_loco.self_modulate = Player_Stats.p6.color_2
		...
		sprite_loco.self_modulate = Player_Stats.p7.color_2
