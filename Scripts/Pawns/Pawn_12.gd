...
var nrg_regen_max = 35
var nrg_default_regen_rate = 5
var nrg_default_regen_max = 35
var light_on_nrg = 34
...
func jumptimer():
	print_debug("jump timer timed out dont know why in pawn 12 player stats says its pawn ",Player_Stats.get_pawn_num(player))
