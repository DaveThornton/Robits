...
onready var my_gun_pos = $POS_Body/Pawn_13_Part_Body/POS_Arm/Pawn_13_Part_Arm/POS_Gun
...
onready var my_attachment_point = $POS_Body/Pawn_13_Part_Body/Attachment_Point

export var my_grav = 8
export var my_max_x_speed = 280
export var my_armor = 2
#-------------------------------------------------------------------JUMP--------
export var my_max_air_jump_count = 0
export var my_max_air_jump_power = 7
export var my_min_air_jump_power = 5
export var my_max_jump_power = 10
...
func _body_(_num: int):
	if _num == 1:
		...
		print_debug("wrong body called in pawn 13", _num)
