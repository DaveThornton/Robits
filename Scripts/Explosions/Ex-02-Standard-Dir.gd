...
#	_check_dir()
	...
	print_debug("1 poly up ", poly_up.disabled)
	print_debug("1 poly right ", poly_right.disabled)
	print_debug("1 poly down ", poly_down.disabled)
	print_debug("1 poly left ", poly_left.disabled)
	_check_dir()
	print_debug("2 poly up ", poly_up.disabled)
